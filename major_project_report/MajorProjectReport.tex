...
\begin{document}
	...
	% Populate the Abbreviations and List of Symbols pages with every defined
	% entry, since the report spells acronyms out in prose rather than via \gls.
	\glsaddall
